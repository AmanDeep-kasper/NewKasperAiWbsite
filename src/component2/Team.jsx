...
const Team= () => {
  ...
  <div className="flex justify-center gap-12 mb-15 mt-10">
    <div className="flex flex-col items-center">
      <img src="./Team-1.svg" alt="Name 1" className="w-[200px] h-[252px] object-cover" />
    ...
    <div className="flex flex-col items-center">
      <img src="./Team-2.svg" alt="Name 2" className="w-[200px] h-[252px] object-cover" />
    ...
    <div className="flex flex-col items-center">
      <img src="./Team-3.svg" alt="Name 2" className="w-[200px] h-[252px] object-cover" />
    ...
    <div className="flex flex-col items-center">
      <img src="./Team-4.png" alt="Name 2" className="w-[200px] h-[252px] object-cover" />
  ...
  <div className="flex justify-center gap-12">
    <div className="flex flex-col items-center">
      <img src="./Team-4.png" alt="Name 3" className="w-[200px] h-[252px] object-cover " />
      <p className="mt-2 font-sora font-normal text-[20px] leading-[1.35] tracking-normal text-center text-[rgba(0, 6, 61, 1)]">Sachin Sahoo</p>
        <p className="mt-2 font-sora font-normal text-[12px] leading-[1.35] tracking-normal text-center text-gray-500">QA Tester</p>
    </div>
    <div className="flex flex-col items-center">
      <img src="./Team-4.png" alt="Name 4" className="w-[200px] h-[252px] h-[200px] object-cover" />
      <p className="mt-2 font-sora font-normal text-[20px] leading-[1.35] tracking-normal text-center text-[rgba(0, 6, 61, 1)]">Sachin Sahoo</p>
        <p className="mt-2 font-sora font-normal text-[12px] leading-[1.35] tracking-normal text-center text-gray-500">QA Testerr</p>
    </div>
    <div className="flex flex-col items-center">
      <img src="./Team-4.png" alt="Name 5" className="w-[200px] h-[252px]  object-cover " />
      <p className="mt-2 font-sora font-normal text-[20px] leading-[1.35] tracking-normal text-center text-[rgba(0, 6, 61, 1)]">Sachin Sahoo</p>
        <p className="mt-2 font-sora font-normal text-[12px] leading-[1.35] tracking-normal text-center text-gray-500">QA Tester</p>
    </div>
     <div className="flex flex-col items-center">
      <img src="./leader1.svg" alt="Name 5" className="w-[200px] h-[252px]  object-cover " />
